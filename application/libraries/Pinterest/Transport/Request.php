...
class Request {
    ...
    public function __construct(CurlBuilder $curlbuilder)
    {
		...
		require_once(APPPATH.'libraries/Pinterest/Transport/Response.php');
		require_once(APPPATH.'libraries/Pinterest/Exceptions/PinterestException.php');
		require_once(APPPATH.'libraries/Pinterest/Exceptions/CurlException.php');
