...
require_once(APPPATH.'libraries/Pinterest/Endpoints/Endpoint.php');
class Users extends Endpoint {
	public function __construct(){
		require_once(APPPATH.'libraries/Pinterest/Models/User.php');
		require_once(APPPATH.'libraries/Pinterest/Models/Collection.php');
	}
