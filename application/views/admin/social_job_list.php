                        ...
                        <tbody>
							<?php foreach($jobdata as $row){?>
								...
								<tr>
									...
									?></td>
									<td width="50px"><?php echo $row['sync_interval']; ?></td>
									<td width="50px"><?php echo $row['sync_frequency']; ?></td>								
									<td><?php echo $row['creation_time']; ?></td>
							    	
									<td><a href="<?php echo site_url('admin/Social_Post/show_post/'.$row['job_id']);?>" data-i18n="nav.invoice.invoice_template" class="menu-item" style="color:#0000CC;">View Report</a></td>
                            	</tr>
							<?php }?>
							<tr>
								<td colspan="10" >
