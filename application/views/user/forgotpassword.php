    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                ...
                <h3 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Forget Password</span></h3>
            </div>
			<div style="color:#FF3333; text-align:center">
				<h4><?php echo @$try_again; echo @$invalid_email;?></h4>
			</div>
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <form class="form-horizontal form-simple" name="form1"  method="post" novalidate>
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="email" value="<?php echo set_value('email'); ?>" placeholder="Your Email Address" required>
                            <div class="form-control-position">
                                <i class="icon-head"></i>
                            </div>
                        </fieldset>
						<br/>
                        <input type="submit" class="btn btn-primary btn-lg btn-block" name="submit" value="Request OTP">
            ...
            <div class="card-footer">
                <div class="">
                    ...
                    <p class="float-sm-right text-xs-center m-0"><a href="#" class="card-link"></a></p>
                </div>
            </div>
        </div>
    </div>
