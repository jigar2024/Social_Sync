								...
								<?php 
									...
									{?>
										<div class="user_image">
											<img src="<?php echo base_url('assets/user/image/');echo @$image;?>">
										</div>
									<?php 	
									}
									?>
								...
								<div class="form-group">
											...
											<div class="input-group">
												...
												<label class="display-inline-block custom-control custom-radio ml-1">
													<input type="radio" name="gender" class="custom-control-input" value="male" <?php if(@$gender=='male'){echo 'checked';}?> />
												...
												<label class="display-inline-block custom-control custom-radio">
													<input type="radio" name="gender" class="custom-control-input" value="female" <?php if(@$gender=='female'){echo 'checked';}?> ?>
													<span class="custom-control-indicator"></span>
